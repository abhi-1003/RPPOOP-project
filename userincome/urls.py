...
urlpatterns = [
    ...
    path('stats', views.stats_view,name="stats1"),   
    path(' export_income_csv', views. export_income_csv, name="export-csv"),
    path('export_pdf', views.export_income_pdf, name="export-pdf"),
]
